"""
Django settings for miniProvisioning project.
...
SECRET_KEY = 'django-insecure-u!577e2*hpuh(c*1h_fqqk=dz^a!#flook$($a8dfc!6o0j@ao'
...
WSGI_APPLICATION = 'miniProvisioning.wsgi.application'
...
#     'sass_processor.finders.CssFinder',  # 추가
# ]
