...
hello!! world!!
EOL
echo "/was/data/test.html 파일 생성 완료. 해당 페이지 수정을 권장드립니다"
cd ..
cd ..
...
docker-compose up -d
echo "**************************compose up 완료******************************** "
echo "docker ps 명령어로 모두 올라와 있는지 확인해 주세요. "
